 ...
 * The Shortcode
 */
function scrn_service_shortcode( $atts ) {
	extract( 
		shortcode_atts( 
			array(
				'icon'			=> '',
...
add_shortcode( 'scrn_service', 'scrn_service_shortcode' );

/**
 * The VC Functions
 */
function scrn_service_vc() {
...
add_action( 'vc_before_init', 'scrn_service_vc');