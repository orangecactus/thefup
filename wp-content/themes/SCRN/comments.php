...
<?php if ( have_comments() ) : ?>
	...
	<div class="row">
      	<div class="col-lg-8 col-lg-push-2 col-md-12">
			<h5><?php comments_number(esc_attr__('No comments','SCRN'), esc_attr__('One comment','SCRN'), '% '.esc_attr__('comments','SCRN') );?></h5>
	...
	<?php if ( ! empty($comments_by_type['pings']) ) : ?>
		<div id="trackbacks">
			<h5 id="trackbacks-title"><?php esc_html_e('Trackbacks/Pingbacks','SCRN') ?></h5>
			<ol class="pinglist">
