...
?>
	<div class="col-sm-8">
		<div class="portfolio-item">
			<ul class="bxslider bx-<?php echo $post->ID;?>">
				<?php 
				if($image1 != '')
	...
	<div class="col-sm-4">
		...
		<?php if($buttontext != '') { ?>
			<a target="_blank" href="<?php if($buttonurl != '') echo $buttonurl; else echo '#';?>">
				<div class="btn btn-default"><?php echo $buttontext;?></div>
			</a>
		<?php } ?>
		<div class="btn btn-default close-project"><?php _e('Close project', 'SCRN');?></div>
	</div> <!-- end one-third column -->
	<div class="clear"></div>
	<script type="text/javascript">
		jQuery('.bx-<?php echo $post->ID;?>').bxSlider();
		jQuery(".portfolio_details .close-project").on("click", function(e) {
			e.preventDefault();
